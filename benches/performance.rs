...
fn criterion_benchmark(c: &mut Criterion) {{}
	...
	c.bench(
		"Day 1",
		Benchmark::new("Part 1",  move|b| b.iter(|| day_01::part1(&day_1_data.clone())))
			.with_function("Part 2",  move |b| b.iter(|| day_01::part2(&day_1_data1.clone())))
			.sample_size(10).measurement_time(std::time::Duration::new(10,0))
	);
	...
	c.bench(
		"Day 2",
		Benchmark::new("Part 1",  move|b| b.iter(|| day_02::part1(&day_2_data.clone())))
			.with_function("Part 2",  move |b| b.iter(|| day_02::part2(&day_2_data1.clone())))
			.sample_size(10).measurement_time(std::time::Duration::new(10,0))
	);
	...
	c.bench(
		"Day 4",
		Benchmark::new("Part 1", |b| b.iter(|| day_04::part1(264_793..803_935)))
